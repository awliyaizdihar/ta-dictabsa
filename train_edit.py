...
class Instructor:
    def __init__(self, opt):
        ...
        self.valset = ABSADataset(opt.dataset_file['dev'], tokenizer, opt.model_name)
        print(f'> validation dataset count: {len(self.valset.data)}.')
...
def main():
    ...
    parser.add_argument('--dataset', default='ulasan_ori', choices=['twitter', 'acl14shortdata', 'SemEval2014',
                                                                 ...
                                                                 'padanan_trim_know', 'padanan_select_know',
                                                                 'combined_ori', 'combined_raw_know',
                                                                 'combined_padanan_know', 'combined_padanan_trim',
                                                                 'combined_padanan_select', 'combined_select_know',
                                                                 'combined_trim_know', 'combined_trim_select_up'], type=str,
    ...
    dataset_files = {
        ...
        'ulasan_raw_know': {
            ...
            'dev': './datasets/ulasan_ori/a_raw_knowledge/dev.tsv',
            'test': './datasets/ulasan_ori/a_raw_knowledge/test.tsv'
        },
        'ulasan_trim_know': {
